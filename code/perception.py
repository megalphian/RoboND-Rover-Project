...
def perception_step(Rover):
    ...
    rock_threshed = color_thresh(warped, (50, 50, 0), (256,256,40))
    obstacle_threshed = color_thresh(warped, (0,0,0), (135,135,135))
    ...
    w_x, w_y = pix_to_world(x, y, Rover.pos[0], Rover.pos[1], Rover.yaw, Rover.worldmap.shape[0], scale)
    r_w_x, r_w_y = pix_to_world(r_x, r_y, Rover.pos[0], Rover.pos[1], Rover.yaw, Rover.worldmap.shape[0], scale)
    o_w_x, o_w_y = pix_to_world(o_x, o_y, Rover.pos[0], Rover.pos[1], Rover.yaw, Rover.worldmap.shape[0], scale)
    # 7) Update Rover worldmap (to be displayed on right side of screen)
        # Example: Rover.worldmap[obstacle_y_world, obstacle_x_world, 0] += 1
        #          Rover.worldmap[rock_y_world, rock_x_world, 1] += 1
        #          Rover.worldmap[navigable_y_world, navigable_x_world, 2] += 1
    Rover.worldmap[o_w_y, o_w_x, 0] += 1
